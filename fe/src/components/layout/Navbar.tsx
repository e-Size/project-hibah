...
export default function Navbar({ variant = "default" }: { variant?: "default" | "transparent" | "light" }) {
  ...
  const navClass = isOverlay
    ? "w-full absolute top-0 left-0 z-20 bg-transparent px-16 py-3 flex items-center justify-between whitespace-nowrap"
    : "w-full bg-[#F8F3E9] px-16 py-3 flex items-center justify-between whitespace-nowrap";
