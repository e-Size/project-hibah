...
export default function CategoryPage() {
  ...
  return (
    ...
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Header */}
      <div className="relative flex flex-col items-center justify-center text-center pt-20 pb-12 md:pb-16 px-4 sm:px-8"
        style={{ background: "radial-gradient(ellipse at 50% 40%, #f5d0c0 0%, #fceee8 35%, #ffffff 70%)" }}>
        {/* Title blocks */}
        <div className="flex flex-col items-center gap-2 mb-6 mt-24 sm:mt-32 md:mt-40">
        ...
        {/* Search bar */}
        <div className="flex items-center gap-2 border-2 border-[#7C6000] rounded-full px-4 sm:px-5 py-3 w-full max-w-sm sm:max-w-lg bg-white/80 mb-8">
