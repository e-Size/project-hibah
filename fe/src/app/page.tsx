// ============================================================
// PRODUCTION HOME PAGE — uncomment & remove MaintenancePage
// to restore. Also remove unused import Image below.
// ============================================================
...
// ============================================================
// MAINTENANCE PAGE — aktif saat ini
// Untuk restore ke production: hapus export di bawah ini,
// lalu uncomment seluruh blok di atas.
// ============================================================
import Image from "next/image";

export default function MaintenancePage() {
  return (
    <main className="min-h-screen bg-[#f5f5f3] flex flex-col items-center justify-center px-5 text-center">
      {/* Logo */}
      <div className="mb-8">
        <Image
          src="/logoesize.png"
      ...
      <div className="w-24 h-1 bg-[#C0980D] rounded-full mb-10" />

      {/* Icon wrench */}
      <div className="mb-6 text-[#C0980D]">
        <svg
      ...
      {/* Heading */}
      <h1 className="font-(family-name:--font-red-rose) text-3xl sm:text-5xl md:text-6xl font-bold text-[#7C6000] uppercase mb-4 leading-tight">
        Under Maintenance
      </h1>

      {/* Subheading */}
      <p className="text-sm sm:text-base md:text-lg text-[#927615] max-w-md mb-10 leading-relaxed">
      ...
      {/* Contact info */}
      <p className="text-xs sm:text-sm text-gray-500 mb-4">Hubungi kami melalui:</p>
      <div className="flex flex-wrap justify-center gap-4 sm:gap-8 font-(family-name:--font-poppins) text-sm text-[#7C6000]">
        <div className="flex items-center gap-2">
          <Image src="/Vector-2.png" alt="" width={18} height={18} className="h-4 w-auto" />
          <span>esize.id</span>
        </div>
        <div className="flex items-center gap-2">
          <Image src="/Vector.png" alt="" width={18} height={18} className="h-4 w-auto" />
          <span>085156043052</span>
        </div>
        <div className="flex items-center gap-2">
          <Image src="/ph_tiktok-logo.png" alt="" width={18} height={18} className="h-4 w-auto" />
          <span>esize.konveksi</span>
        </div>
      </div>

      {/* Corner decorations */}
      <span className="fixed top-6 left-6 w-10 h-10 border-t-4 border-l-4 border-[#C0980D] rounded-tl-sm" />
      <span className="fixed top-6 right-6 w-10 h-10 border-t-4 border-r-4 border-[#C0980D] rounded-tr-sm" />
      <span className="fixed bottom-6 left-6 w-10 h-10 border-b-4 border-l-4 border-[#C0980D] rounded-bl-sm" />
      <span className="fixed bottom-6 right-6 w-10 h-10 border-b-4 border-r-4 border-[#C0980D] rounded-br-sm" />
    </main>
  );
}
